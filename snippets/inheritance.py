...
Die erbenden Klassen heissen Oberklassen (superclasses/parent classes). Sie erben alle Eigenschaften
und Methoden der Unterklasse/Basisklasse (subclass/child class). Vererbte Methoden können aber auch
