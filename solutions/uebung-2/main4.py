...
Schreiben Sie ein Programm, welches den Benutzer wiederholt mit Fragen der Art "Ist die Zahl grösser als ... (j/n)"
konfrontiert und damit die vom Benutzer ausgedachte Zahl errät.
